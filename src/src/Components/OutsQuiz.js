...
function OutsQuiz() {
  ...
  const answerSubmit = () => {
    if (formData.inputAnswer === boardState.correctAnswer) {
      ...
      if (stateIndex === stateArray.length - 1) {
        endQuiz();
      }
    } else {
  ...
  const stateArray = [
    ...
    //////////////////////////////
    {
      card1: { suit: "spade", value: "3" },
      card2: { suit: "heart", value: "3" },
      card3: { suit: "club", value: "4" },
      card4: { suit: "diamond", value: "5" },
      card5: { suit: "", value: "" },
      pcard1: { suit: "club", value: "ace" },
      pcard2: { suit: "diamond", value: "King" },
      vcard1: { suit: "club", value: "2" },
      vcard2: { suit: "heart", value: "2" },
      correctAnswer: "12",
      answerDescription: "Correct! Since a 2 would give the opponent a full house, you have 3 Aces, 3 Kings, 3 Fours and 3 Fives to make either a higher pair or counterfeit the opponents two pair.",
    },
    //////////////////////////////
    {
      card1: { suit: "spade", value: "king" },
      card2: { suit: "spade", value: "10" },
    ...
    //////////////////////////////
    {
      ...
      card2: { suit: "spade", value: "10" },
      card3: { suit: "spade", value: "queen" },
      card4: { suit: "diamond", value: "queen" },
      card5: { suit: "", value: "" },
      pcard1: { suit: "spade", value: "ace" },
      pcard2: { suit: "heart", value: "10" },
      vcard1: { suit: "club", value: "queen" },
      ...
      correctAnswer: "1",
      answerDescription:
        "Correct! Only a spade King would give you a royal flush, as the opponent already has four of a kind. Yeah... I had to throw that one in there.",
    },
  ];
  ...
  return (
    <Container>
      {quizStarted === false && !quizComplete ? (
      ...
      {quizStarted ? (
        <>
          ...
          <div className="boardCards">
            ...
            />
            <PHand
              value={boardState.card4.value}
              suit={boardState.card4.suit}
              newDeal={newDeal}
            />
            <PHand
              value={boardState.card5.value}
              suit={boardState.card5.value}
              newDeal={newDeal}
            />
          </div>
